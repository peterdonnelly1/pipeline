...
--min_uniques=${MINIMUM_PERMITTED_UNIQUE_VALUES}  --whiteness=${MAXIMUM_PERMITTED_WHITENESS} --greyness=${MINIMUM_PERMITTED_GREYSCALE_RANGE} --colour_norm=${COLOUR_NORMALIZATION} 
