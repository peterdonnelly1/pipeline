...
if [[ ${CLUSTERING} == "all" ]]
  ...
  then
    ...
    ./do_all.sh -d ${DATASET}  -i ${INPUT_MODE}  -t 5000  -x ${N_CLUSTERS}  -X True -s True  -g True  -n classify  -c ${CASES}  -l cuda_tsne  -p "10 30 70 100 300 700 1000 3000 7000"  -G ${SUPERGRID_SIZE} -u ${USE_AUTOENCODER_OUTPUT}
