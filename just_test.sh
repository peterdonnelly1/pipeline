...
--class_numpy_file_name ${CLASS_NUMPY_FILENAME} --nn_mode ${NN_MODE} --nn_type ${NN_TYPE} --optimizer ${NN_OPTIMIZER} --n_samples ${N_SAMPLES} --slide_cog ${SLIDE_COG} --pct_test ${PCT_TEST} --n_genes ${N_GENES} --gene_data_norm ${GENE_DATA_NORM} --class_names ${CLASS_NAMES} \
