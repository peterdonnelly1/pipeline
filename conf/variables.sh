...
#     N_GENES=505                                                         # 60483 genes in total for STAD rna-sq data (505 map to PMCC gene panel genes of interest)
      ...
      COV_THRESHOLD=4.5                                                 # minimum threshold for analyse_data analyses (covariance, PCA etc). Genes with all values below COV_THRESHOLD will be removed BEFORE analysis commences
      COV_UQ_THRESHOLD=0.09                                               # minimum upper quartile value for display of analyse_data analyses Genes whose UQ is below OV_UQ_THRESHOLD will be ignored       
