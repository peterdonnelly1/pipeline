...
#NN_MAIN_APPLICATION_NAME=traindpcca.py
#NN_DATASET_HELPER_APPLICATION_NAME=data.gtexv6.generate
NN_MAIN_APPLICATION_NAME=trainlenet5.py
NN_DATASET_HELPER_APPLICATION_NAME=data.dlbcl_image.generate
N_EPOCHS=99999
BATCH_SIZE=256
LATENT_DIM=1
