...
if [[ ${DATASET} == "stad" ]]; 
  ...
  if [[ ${INPUT_MODE} == "image" ]]
    then
      ...
      TILES_PER_IMAGE="200"                                              # Training mode only. (this parameter is automatically calculated in 'just_test mode')   <450 for Moodus 128x128 tiles. (
      N_EPOCHS=4                                                         # automatically set to '1' in test mode
