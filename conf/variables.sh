...
N_EPOCHS=500
BATCH_SIZE=32                                                           # NOTE: WILL BE OVERWRITTEN BY ITERTOOLS
...
TILES_TO_GENERATE_PER_SVS=32                                            # set up so that ALL tiles will be consumed by the "generate.py" function. Maximum about 300 for the MSI laptop.
