...
--input_mode ${INPUT_MODE} --use_tiler 'external'  --skip_preprocessing 'True' --skip_generation 'True' --dataset ${DATASET}     --data_dir ${DATA_DIR} --rna_file_name ${RNA_NUMPY_FILENAME} --class_numpy_file_name ${CLASS_NUMPY_FILENAME} \
