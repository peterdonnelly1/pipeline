...
./do_all.sh     -d ${DATASET}  -i ${INPUT_MODE}      -t 5000        -x ${N_CLUSTERS}                                -s True             -g True             -n dlbcl_image  -u True  -c NOT_A_MULTIMODE_CASE_FLAG  -l ${CLUSTERING}   -u ${USE_AUTOENCODER_OUTPUT}
