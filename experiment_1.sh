...
./do_all.sh -d kidn -i rna -I False -D just_hg38_protein_coding_genes   -L .00001  -H 2100  -7 .20                                    -X True  -g True  -R 8

./do_all.sh -d kidn -i rna -I False -D pmcc_cancer_genes_of_interest    -L .00001  -H 2100  -7 .20                                    -X True  -g True  -R 8

# ./do_all.sh -d kidn -i rna -I False -D KIDN_genes_of_interest           -L .00001  -H 2100  -7 .20                                  -X True  -g True  -R 8
...
./do_all.sh -d kidn -i rna -L .00001  -H 2200  -7 .20   -4 "ADAM ADAMAX ADAGRAD ADAMW ADAMW_AMSGRAD ADADELTA ASGD RMSPROP RPROP SGD"  -X True  -g True
