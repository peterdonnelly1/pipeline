...
from   data.analyse_data.dataset import analyse_dataDataset
...
class analyse_dataConfig(Config):
...
#    N_PIXELS       = N_CHANNELS * IMG_SIZE * IMG_SIZE
    ...
    def __init__(self, lr,  batch_size ):
      ...
      if DEBUG>1:
        print( "A_D_CONFIG:         INFO:     at \033[35;1m __init__()\033[m:   current learning rate / batch_size  = \033[36;1m{:}, {:}\033[m respectively".format( lr,  batch_size ) )
...
# ------------------------------------------------------------------------------
    ...
    def get_image_net(self, nn_type, n_classes, n_genes, nn_dense_dropout_1, nn_dense_dropout_2, tile_size ):
      ...
      if DEBUG>0:
        print( "A_D_CONFIG:         INFO:     at \033[35;1m get_image_net()\033[m:   nn_type  = \033[36;1m{:}\033[m".format( nn_type ) )
...
# ------------------------------------------------------------------------------
    ...
    def get_genes_net(self, nn_type, n_classes, n_genes, nn_dense_dropout_1, nn_dense_dropout_2 ):
      ...
      if DEBUG>0:
        print( "A_D_CONFIG:         INFO:     at \033[35;1m get_genes_net()\033[m:   nn_type  = \033[36;1m{:}\033[m".format( nn_type ) )
...
# ------------------------------------------------------------------------------
    ...
    def save_samples(self, directory, model, desc, x2, labels):
      ...
      if DEBUG>9:
        print( "A_D_CONFIG:         INFO:       at top of save_samples() and parameter directory = \033[35;1m{:}\033[m".format( directory ) )
