...
INPUT: (i)  the code will traverse data_dir to locate png files for processing
...
def generate_image( args ):
  ...
  print( "GENERATE_IMAGE: INFO:      generate_image(): \
...
.format( args.data_dir, args.tile_size, args.rna_file_name, args.class_numpy_file_name, args.n_samples, args.n_tiles, args.n_genes ), flush=True )
  ...
  print ( "GENERATE_IMAGE: INFO:    user defined max tiles per SVS  = \033[31m{:}\033[m".format(n_tiles))
