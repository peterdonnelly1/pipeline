...
from   data.analyse_data.config  import analyse_dataConfig             # use for any dataset when pre-compressing
from   data.analyse_data.dataset import analyse_dataDataset            # use for any dataset when pre-compressing
