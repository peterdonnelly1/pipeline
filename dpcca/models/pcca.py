...
# ------------------------------------------------------------------------------
    ...
    def __repr__(self):
        """Compute a printable representation of a PCCJ object.
...
# ------------------------------------------------------------------------------
    ...
    def tile_params(self):
        """Tile parameters so we can use factor analysis updates for PCCJ.
...
# ------------------------------------------------------------------------------
    ...
    def parameters_(self, view=None):
        """Generates an iterator of parameters for the PCCJ instance.
