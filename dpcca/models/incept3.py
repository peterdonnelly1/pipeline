...
class InceptionE(nn.Module):
    ...
    def __init__(self, in_channels, conv_block=None):
        ...
        if DEBUG>99:
          print ( "INCEPT3:        INFO:     encode(): type(conv_block) = {:}".format  (  type(conv_block)  ) )
          print ( "INCEPT3:        INFO:     encode(): conv_block       = {:}".format  ( conv_block  ) )
          print ( "INCEPT3:        INFO:     encode(): in_channels      = {:}".format ( in_channels ) )
