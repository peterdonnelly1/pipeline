...
from   models.ae3layerconv3d  import AE3LAYERCONV3D   # used by pre_compress                                      # Autoencoder. Interface suitable for 'NN_MODE=pre_compress' only ATM. Don't use for 'NN_MODE=gtexv6'
