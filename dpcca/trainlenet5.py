...
#  (0) define two functions which will be used to draw the secondary 'tile' axes (top and right)
  ...
  if len(image_labels)>=threshold_3:
    #          x     y
    ax.text(   0,  -110, t2, size=10, ha="left",   color="black", style="normal", fontname="DejaVu Sans", weight='bold' )            
    ax.text(   0,  -80, t3, size=10, ha="left",   color="black", style="normal" )
    ax.text( 550,  -80, t4, size=10, ha="left",   color="black", style="italic" )
    ax.text(   0,  -40, t5, size=10, ha="left",   color="black", style="normal" )
    ax.text( 550,  -40, t6, size=10, ha="left",   color="black", style="italic" )    
    ...
    ax.text( 550,  -26, t4, size=10, ha="left",   color="black", style="italic" )
    ax.text(   0,  -40, t5, size=10, ha="left",   color="black", style="normal" )
    ax.text( 550,  -40, t6, size=10, ha="left",   color="black", style="italic" )    
