...
--input_mode ${INPUT_MODE} --use_tiler ${USE_TILER}  --skip_preprocessing 'True' --skip_generation 'True' --dataset ${DATASET} --data_dir ${DATA_DIR} --rna_file_name ${RNA_NUMPY_FILENAME} \
