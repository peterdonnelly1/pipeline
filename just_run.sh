...
--class_numpy_file_name ${CLASS_NUMPY_FILENAME} --nn_mode ${NN_MODE} --nn_type ${NN_TYPE} --nn_dense_dropout_1 ${NN_DENSE_DROPOUT_1}  --nn_dense_dropout_2 ${NN_DENSE_DROPOUT_2} --optimizer ${NN_OPTIMIZER} --n_samples ${N_SAMPLES} --pct_test ${PCT_TEST} \
