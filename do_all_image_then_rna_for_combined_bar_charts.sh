...
./do_all.sh      -d stad  -i image                    -c UNIMODE_CASE____UNMATCHED       -v True           # -v ('divide_classes') option causes the cases to be divided into UNIMODE_CASE____MATCHED and MULTIMODE____TEST. Do this once only.
