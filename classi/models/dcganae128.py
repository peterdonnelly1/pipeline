...
class DCGANAE128(nn.Module):
    ...
    def __init__(self, cfg):
        ...
        print ( "DCGANAE128:     INFO:    at \033[33;1mat __init__()\033[m" )
...
# ------------------------------------------------------------------------------
    ...
    def encode(self, x):
        ...
        if DEBUG>0:
          print ( "DCGANAE128:     INFO:                  encode(): ((self.discriminator(x))view(x.shape[0], -1)).shape = {:}".format( ((self.discriminator(x)).view(x.shape[0], -1)).shape   ) )
