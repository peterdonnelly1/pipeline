...
from models._presets import ImageClassification
...
from models._utils_2 import handle_legacy_interface, _ovewrite_named_param
...
class DenseNet(nn.Module):
    ...
    def __init__(
        ...
        self.classifier = nn.Linear(num_features, n_classes)                                               # PGD 220617
    ...
    def forward( self, x: Tensor,  batch_fnames) -> Tensor:
        ...
        if DEBUG>100:
          print ( f"DENSENET:       INFO:     on return from forward()                    x.size      = {MIKADO}{x.size()}{RESET}{CLEAR_LINE}" )
...
def _densenet( cfg, args, n_classes, tile_size, 
    growth_rate: int,
    ...
    **kwargs: Any,
    ...
    model = DenseNet( n_classes, growth_rate, block_config, num_init_features, **kwargs)
...
def densenet121(cfg, args, n_classes, tile_size, *, weights: Optional[DenseNet121_Weights] = None, progress: bool = True, **kwargs: Any) -> DenseNet:
    ...
    return _densenet(cfg, args, n_classes, tile_size, 32, (6, 12, 24, 16), 64, weights, progress, **kwargs)


@handle_legacy_interface(weights=("pretrained", DenseNet161_Weights.IMAGENET1K_V1))
def densenet161(cfg, args, n_classes, tile_size, *, weights: Optional[DenseNet161_Weights] = None, progress: bool = True, **kwargs: Any) -> DenseNet:
    ...
    return _densenet(cfg, args, n_classes, tile_size, 48, (6, 12, 36, 24), 96, weights, progress, **kwargs)


@handle_legacy_interface(weights=("pretrained", DenseNet169_Weights.IMAGENET1K_V1))
def densenet169(cfg, args, n_classes, tile_size, *, weights: Optional[DenseNet169_Weights] = None, progress: bool = True, **kwargs: Any) -> DenseNet:
    ...
    return _densenet(cfg, args, n_classes, tile_size, 32, (6, 12, 32, 32), 64, weights, progress, **kwargs)


@handle_legacy_interface(weights=("pretrained", DenseNet201_Weights.IMAGENET1K_V1))
def densenet201(cfg, args, n_classes, tile_size, *, weights: Optional[DenseNet201_Weights] = None, progress: bool = True, **kwargs: Any) -> DenseNet:
    ...
    return _densenet(cfg, args, n_classes, tile_size, 32, (6, 12, 48, 32), 64, weights, progress, **kwargs)


# The dictionary below is internal implementation detail and will be removed in v0.15
from models._utils_2 import _ModelURLs
