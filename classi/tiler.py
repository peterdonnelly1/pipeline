...
\r\033[{start_row-2};{start_column+16+4}fexamined\
\r\033[{start_row-2};{start_column+32+4}fof which... accepted\
...
\r\033[{start_row+my_thread};{start_column+16}f{tiles_considered_count:6d}   \
\r\033[{start_row+my_thread};{start_column+26}f{tiles_processed:6d}  ({tiles_processed/[tiles_considered_count                 if tiles_considered_count>0 else .000000001][0] *100:3.0f}%)   \
