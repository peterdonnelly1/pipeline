            ...
            if stain_norm=="spcn":
              ...
              if ( f.endswith( "svs" ) ) | ( f.endswith( "SVS" ) ) | ( f.endswith( "tif" ) ) | ( f.endswith( "tif" ) )  | ( f.endswith( "TIF" ) ) | ( f.endswith( "TIFF" ) ):
                ...
                if DEBUG>0:
                  ...
                  print ( f"\033[{start_row+my_thread};{start_column+210}f{RESET}{CLEAR_LINE}{r} \033[{start_row+my_thread};{start_column+227}f{RESET}tiles={MIKADO}{cumulative_tiles_processed:,}{RESET}", flush=True  )                
