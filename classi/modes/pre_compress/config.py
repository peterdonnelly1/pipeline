...
from   models                    import LENET5, AELINEAR, AEDENSE, AEDENSEPOSITIVE, AE3LAYERCONV2D, AEDCECCAE_3, AEDCECCAE_5, AEVGG16, AEDEEPDENSE, TTVAE, VGG, VGGNN, INCEPT3, DENSE, DENSEPOSITIVE, CONV1D, DCGANAE128
from modes.pre_compress.dataset import pre_compressDataset
...
# ------------------------------------------------------------------------------
    ...
    def get_image_net( self, args, gpu, rank, input_mode, nn_type_img, encoder_activation, n_classes, n_genes, hidden_layer_neurons, embedding_dimensions, nn_dense_dropout_1, nn_dense_dropout_2, tile_size  ):
