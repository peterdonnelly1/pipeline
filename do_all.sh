...
echo "===> STARTING"
echo "=====> STEP 1 OF 5: GENERATING TILES FROM SVS IMAGES"
...
echo "=====> STEP 2 OF 5: PLACING COPY OF ENTIRE TRUTH VECTOR (e.g. 'TISSUE CLASS') INTO EACH CASE SUB-DIRECTORY AS FILE 'class.csv' FOR SUBSEQUENT USE"
sleep 1
./setup_class_files.sh


echo "=====> STEP 3 OF 5: EXTRACTING RNA EXPRESSION & CLASS INFORMATION, SAVING AS NUMPY FILE"
sleep 1
...
echo "=====> STEP 4 OF 5: CONVERTING DATA INTO FORMAT SUITABLE FOR PYTORCH TO USE (DICTIONARY OF TORCH TENSORS)"
sleep 1
