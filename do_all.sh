...
MINIMUM_PERMITTED_GREYSCALE_RANGE=120                                                                      # used in 'save_svs_to_tiles' to filter out tiles that have extremely low information content. Don't set too high
MINIMUM_PERMITTED_UNIQUE_VALUES=120                                                                      # tile must have at least this many unique values or it will be assumed to be degenerate
MIN_TILE_SD=1.0                                                                                              # Used to cull slides with a very reduced greyscale palette such as background tiles
