...
--input_mode ${INPUT_MODE} --use_tiler ${USE_TILER} --just_profile ${JUST_PROFILE} --skip_preprocessing 'True' --skip_generation 'False' --dataset ${DATASET} --data_dir ${DATA_DIR} --rna_file_name ${RNA_NUMPY_FILENAME} \
